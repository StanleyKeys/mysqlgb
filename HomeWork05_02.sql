...
SELECT train_id, station, station_time, TIMEDIFF(LEAD(station_time) OVER(PARTITION BY train_id ORDER by train_id), station_time) AS time_to_next_station
FROM Train_schedule;