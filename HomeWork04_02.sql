...
SELECT an_name AS AnalysisName, an_price AS Price, ord_datetime AS date
FROM Analysis, Orders
WHERE DATEDIFF("2020-02-05", ord_datetime) = -5; -- DATEDIFF(значение, название столбца) = число (какой диапазон в днях)
